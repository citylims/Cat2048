...
var ImageLoader = function (_React$Component) {
  ...
  _createClass(ImageLoader, [{
    key: 'defineImage',
    value: function defineImage() {
      if (this.props.sourceCollection.length) {
        var imageMap = this.props.sourceCollection.map(function (source) {
          return React.createElement('img', { className: 'image-preview', src: source });
        });
        return imageMap;
      }
    }
